...
urlpatterns = [
    ...
    path('cats/<int:finch_id>/assoc_tag/<int:tag_id>/', views.assoc_tag, name='assoc_tag'),
    path('cats/<int:finch_id>/unassoc_tag/<int:tag_id>/', views.unassoc_tag, name='unassoc_tag'),
